...
def begin_drag():
    ...
    dragging = True
    #actions.user.parrot_config_set_mode("dragging")

def end_drag_and_click():
    global dragging
    if dragging:
        ...
        actions.user.mouse_button(0, 16000)

default_config = {
    "palate_click:th_150": ('left click', lambda: end_drag_and_click()),
    "tut:th_150": ('right click', lambda: actions.user.mouse_button(1, 16000)),
    # "clock:th_150": ('quick action', lambda: play_target_less_card()),
    "alveolar_click:th_150": ('drag toggle', lambda : begin_drag()),
...
dragging_config = {
    **default_config,
    # "ah:th_250": ('rotate left', lambda : actions.user.button("q")),
    # "oh:th_250": ('rotate right', lambda : actions.user.button("e")),
}


parrot_config = {
    "default": default_config,
    "dragging": dragging_config,
