...
default_config = {
    ...
    "hiss_stop:db_250": ("right click endp",lambda: actions.user.mouse_drag_end()),
    ...
    "mm:th_100": ("q",lambda: actions.user.button_down("d")),
    "mm_stop": ("q",lambda: actions.user.button_up("d")),
    "shush": ("flash2",lambda: actions.user.button_hold("f",16000)),
